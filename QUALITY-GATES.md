...
- **JSON-LD (14 default types):** GAP —
  0/14 present. Missing: Organization, WebSite, WebPage, Product, Offer, AggregateRating, BreadcrumbList, FAQPage, Service, LocalBusiness, Person, Article, Review, ImageObject.
  Top-up: skip.
